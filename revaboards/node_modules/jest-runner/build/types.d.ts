...
export declare type Context = {
    com.revaboard.config: Config.ProjectConfig;
    hasteFS: HasteFS;
    moduleMap: ModuleMap;
...
export declare type TestFramework = (globalConfig: Config.GlobalConfig, com.revaboard.config: Config.ProjectConfig, environment: JestEnvironment, runtime: Runtime, testPath: string) => Promise<TestResult>;
