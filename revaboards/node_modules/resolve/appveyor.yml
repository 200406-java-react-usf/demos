...
install:
 ...
 - git com.revaboard.config core.symlinks true
 - git reset --hard
 # Get the latest stable version of Node.js or io.js
 - ps: Install-Product node $env:nodejs_version $env:platform
 - IF %nodejs_version% EQU 0.6 npm com.revaboard.config set strict-ssl false && npm -g install npm@1.3
 - IF %nodejs_version% EQU 0.8 npm com.revaboard.config set strict-ssl false && npm -g install npm@1.4.28 && npm install -g npm@4.5
 - set PATH=%APPDATA%\npm;%PATH%
