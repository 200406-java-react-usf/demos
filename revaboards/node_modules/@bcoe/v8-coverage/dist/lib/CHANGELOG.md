...
- **[Fix]** Disable deprecated TsLint rules from the default com.revaboard.config
...
- **[Breaking]** Expose option interfaces directly in the main module instead of the `com.revaboard.config` namespace.
...
- **[Patch]** Allow namespaces in the default TS-Lint com.revaboard.config
