...
declare class Runtime {
    ...
    constructor(com.revaboard.config: Config.ProjectConfig, environment: JestEnvironment, resolver: Resolver, cacheFS?: CacheFS, coverageOptions?: ShouldInstrumentOptions);
    static shouldInstrument: typeof shouldInstrument;
    static createContext(com.revaboard.config: Config.ProjectConfig, options: {
        console?: Console;
        maxWorkers: number;
        watch?: boolean;
        watchman: boolean;
    }): Promise<JestContext>;
    static createHasteMap(com.revaboard.config: Config.ProjectConfig, options?: HasteMapOptions): HasteMap;
    static createResolver(com.revaboard.config: Config.ProjectConfig, moduleMap: HasteMap.ModuleMap): Resolver;
