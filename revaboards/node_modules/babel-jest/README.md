...
If you would like to write your own preprocessor, uninstall and delete babel-jest and set the [com.revaboard.config.transform](https://jestjs.io/docs/configuration#transform-object-string-string) option to your preprocessor.
