...
- [`Partial<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1401-L1406) - Make all properties in `T` optional.
	...
	class NodeAppBuilder {
			...
			com.revaboard.config(com.revaboard.config: Partial<NodeConfig>) {
					type NodeConfigKey = keyof NodeConfig;

					for (const key of Object.keys(com.revaboard.config) as NodeConfigKey[]) {
							const updateValue = com.revaboard.config[key];
	...
	new NodeAppBuilder().com.revaboard.config({appName: 'ToDoApp'});
	```
	</details>
...
- [`Readonly<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1415-L1420) - Make all properties in `T` readonly.
	...
	class Logger {
			com.revaboard.config: Readonly<LoggerConfig>;

			constructor({name, level}: LoggerConfig) {
					this.com.revaboard.config = {name, level};
					Object.freeze(this.com.revaboard.config);
			}
	}

	const com.revaboard.config: LoggerConfig = {
		name: 'MyApp',
		level: LogLevel.Debug
	};

	const logger = new Logger(com.revaboard.config);

	// TypeScript Error: cannot assign to read-only property.
	logger.com.revaboard.config.level = LogLevel.Error;

	// We are able to edit com.revaboard.config variable as we please.
	com.revaboard.config.level = LogLevel.Error;
	```
	</details>
...
- [`Exclude<T, U>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1436-L1439) - Exclude from `T` those types that are assignable to `U`.
	...
	function startServer(handler: RequestHandler, com.revaboard.config: ServerConfig): void {
		const server = require('http').createServer(handler);

		const port = com.revaboard.config.port === null ? 3000 : getPortValue(com.revaboard.config.port);
		server.listen(port);
	}
	```
	</details>
