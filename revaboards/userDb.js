...
module.exports = [
    ...
    new User(id++, 'ccountryman', 'password', 'Charlie', 'Countryman','ccountryman@revature.com', new Date('01/01/')),
    new User (id++, 'ddavis', 'password', 'Daniel', 'Davis','ddavis@revature.com', new Date('07/01/1990')),
    new User(id++, 'eeinstein', 'password', 'Emily', 'Einstein','eeinsteing@revature.com', new Date('09/01/1993'))
]