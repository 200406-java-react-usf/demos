...
#
#	JSL_FILES_NODE	JavaScript files to check with Node com.revaboard.config file.
#	JSL_FILES_WEB	JavaScript files to check with Web com.revaboard.config file.
#
