...
When using `node-notifier` inside of `webpack`, you must add the snippet below to your `webpack.com.revaboard.config.js`.
...
Do so by append the following code to your `webpack.com.revaboard.config.js`:
