...
export declare const usage = "Usage: $0 [--com.revaboard.config=<pathToConfigFile>] [TestPathPattern]";
...
export declare const options: {
    ...
    readonly debug: {
        readonly default: undefined;
        readonly description: "Print debugging info about your jest com.revaboard.config.";
        readonly type: "boolean";
    };
    ...
    readonly showConfig: {
        readonly default: undefined;
        readonly description: "Print your jest com.revaboard.config and then exits.";
        readonly type: "boolean";
    };
    readonly silent: {
        readonly default: undefined;
