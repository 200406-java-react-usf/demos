...
export default class DefaultReporter extends BaseReporter {
    ...
    testFinished(com.revaboard.config: Config.ProjectConfig, testResult: TestResult, aggregatedResults: AggregatedResult): void;
    printTestFileHeader(_testPath: Config.Path, com.revaboard.config: Config.ProjectConfig, result: TestResult): void;
