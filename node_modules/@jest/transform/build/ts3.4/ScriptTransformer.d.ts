...
export default class ScriptTransformer {
    ...
    constructor(com.revaboard.config: Config.ProjectConfig);
...
export declare function createTranspilingRequire(com.revaboard.config: Config.ProjectConfig): <TModuleType = unknown>(resolverPath: string, applyInteropRequireDefault?: boolean) => TModuleType;
