 ...
 * Fix: allow jsdom.env's com.revaboard.config.html to handle file paths which contain spaces (shinuza)
 ...
 * Added src com.revaboard.config option to jsdom.env() (Jerry Sievert)
