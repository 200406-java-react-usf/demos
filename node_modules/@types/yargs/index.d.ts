...
declare namespace yargs {
    ...
    interface Argv<T = {}> {
        ...
        /**
         * Tells the parser that if the option specified by `key` is passed in, it should be interpreted as a path to a JSON com.revaboard.config file.
         ...
         *
         * If invoked without parameters, `.com.revaboard.config()` will make --com.revaboard.config the option to pass the JSON com.revaboard.config file.
         *
         * @param [description] Provided to customize the com.revaboard.config (`key`) option in the usage string.
         * @param [explicitConfigurationObject] An explicit configuration `object`
         */
        com.revaboard.config(): Argv<T>;
        com.revaboard.config(key: string | ReadonlyArray<string>, description?: string, parseFn?: (configPath: string) => object): Argv<T>;
        com.revaboard.config(key: string | ReadonlyArray<string>, parseFn: (configPath: string) => object): Argv<T>;
        com.revaboard.config(explicitConfigurationObject: object): Argv<T>;
        ...
        /**
         * Similar to `com.revaboard.config()`, indicates that yargs should interpret the object from the specified key in package.json as a configuration object.
    ...
    interface Options {
        ...
        coerce?: (arg: any) => any;
        /** boolean, interpret option as a path to a JSON com.revaboard.config file, see `com.revaboard.config()` */
        com.revaboard.config?: boolean;
        /** function, provide a custom com.revaboard.config parsing function, see `com.revaboard.config()` */
