...
export interface ResolveConfigOptions {
    ...
    useCache?: boolean;
    /**
     * Pass directly the path of the com.revaboard.config file if you don't wish to search for it.
     */
 ...
 * passing its path as the first argument. The com.revaboard.config search will start at the
 ...
 *
 *  - An options object, providing a [com.revaboard.config file](https://github.com/prettier/prettier#configuration-file) was found.
 ...
 * that will be used when resolving the com.revaboard.config (i.e. when calling `resolveConfig`).
 *
 * A promise is returned which will resolve to:
 *
