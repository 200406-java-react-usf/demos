...
If you don't provide options in your Babel com.revaboard.config, the plugin will look for `exclude`/`include` com.revaboard.config under an `"nyc"` key in `package.json`.
